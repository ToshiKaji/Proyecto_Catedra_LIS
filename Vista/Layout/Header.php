...
<body>
    ...
    <nav class="navbar navbar-expand-lg fixed-top navbar-light bg-danger">
        <div class="container-fluid d-flex">
            <a class="navbar-brand mb-0 h1 ms-5" style="color:#FFFFFF; font-weight: bold;" href="../Cupones/Inicio.php">
            ...
            <ul class="nav nav-pills">
                <li class="nav-item">
                <a class="nav-link" style="color:#FFFFFF;" href="../Cupones/Inicio.php">Inicio</a>
                </li>
                <li class="nav-item">
