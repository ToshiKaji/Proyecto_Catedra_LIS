            ...
            ?>
                    <div class="card mb-5" style="width: 50rem;">
                        <div class="card-body d-flex flex-column justify-content-center align-items-center">
                            <form action="<?=PATH?>/Cupones/Comprar/<?=$codigo_generado?>.<?=$viewBag[3]?>.<?=$id_cupon?>" method="POST">
                                <h4 class="text-center py-3">Tu Pedido</h4>
                                <hr>
                                <p>Compra de:<(con una variable de sesion pasamos la info necesaria)/p>
                                <hr>
                                <div class="row">
                                <h4 class="text-center py-3">Datos de Compra</h4>
                                <div class="col-md-6">
                                <input type="password" name="n_tarjeta" id="n-tarjeta" class="form-control mb-3" placeholder="N° de Tarjeta" 
